package dev.seabat.ramennote.ui.theme
...
private val mediumContrastLightColorScheme =
    lightColorScheme(
        ...
        background = onPrimaryLightMediumContrast, // onPrimary に変更
...
private val mediumContrastDarkColorScheme =
    darkColorScheme(
        ...
        background = onPrimaryDarkMediumContrast, // onPrimary に変更
...
fun RamenNoteTheme(
    ...
    MaterialTheme(
        ...
        typography = RamenNoteTypography,
        content = content
    )
}
