...
### ステップ1: コードの読み込みと現状把握
- `composeApp/src/commonMain/kotlin/dev/seabat/ramennote/ui/screens/` 配下の対象画面ファイルを読む
